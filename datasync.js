...
export function initThinBackend({ host }) {
    if (typeof host !== "string" || (!host.startsWith("http://") && !host.startsWith("https://"))) {
        throw new Error("Thin Backend host url needs to start with \"http://\" or \"https://\", you passed \"" +  host + "\"")
    }
    if (host.endsWith('/')) {
        throw new Error('Thin Backend host url should not have a trailing slash, please remove the last \"/\" from \"' + host + "\"")
    }
...
export { DataSyncController, DataSubscription };
